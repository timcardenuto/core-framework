...
base_programmable_base::base_programmable_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl) :
...
base_programmable_base::base_programmable_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev) :
...
base_programmable_base::base_programmable_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities) :
...
base_programmable_base::base_programmable_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev) :
...
base_programmable_base::~base_programmable_base()
{
}

void base_programmable_base::construct()
{
    loadProperties();
...
void base_programmable_base::loadProperties()
{
