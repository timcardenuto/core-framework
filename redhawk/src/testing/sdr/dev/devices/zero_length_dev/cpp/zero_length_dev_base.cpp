...
zero_length_dev_base::zero_length_dev_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl) :
...
zero_length_dev_base::zero_length_dev_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev) :
...
zero_length_dev_base::zero_length_dev_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities) :
...
zero_length_dev_base::zero_length_dev_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev) :
...
zero_length_dev_base::~zero_length_dev_base()
{
}

void zero_length_dev_base::construct()
{
    loadProperties();
...
void zero_length_dev_base::loadProperties()
{
