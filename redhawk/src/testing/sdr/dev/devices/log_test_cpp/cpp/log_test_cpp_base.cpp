...
log_test_cpp_base::log_test_cpp_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl) :
...
log_test_cpp_base::log_test_cpp_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev) :
...
log_test_cpp_base::log_test_cpp_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities) :
...
log_test_cpp_base::log_test_cpp_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev) :
...
log_test_cpp_base::~log_test_cpp_base()
{
}

void log_test_cpp_base::construct()
{
    loadProperties();
...
void log_test_cpp_base::loadProperties()
{
