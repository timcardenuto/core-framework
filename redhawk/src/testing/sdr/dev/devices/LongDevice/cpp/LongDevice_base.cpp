...
LongDevice_base::LongDevice_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl) :
...
LongDevice_base::LongDevice_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev) :
...
LongDevice_base::LongDevice_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities) :
...
LongDevice_base::LongDevice_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev) :
...
LongDevice_base::~LongDevice_base()
{
}

void LongDevice_base::construct()
{
    loadProperties();
...
void LongDevice_base::loadProperties()
{
